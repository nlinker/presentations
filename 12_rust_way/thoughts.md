...
Инкапсуляция это не собственность ООП и даже не его изобретение!

Сокрытие доступа к данным cамо по себе вещь неплохая, это позволяет сохранить внутренние инварианты и избежать ошибок.

таким образом внешние модули будут иметь доступ только к тем полям и функциям, которые помечены pub.


Бонус: наследование + мутабельность